...
const DeployGitHub = () => {
  ...
  const deployStudio = () => {
    ...
    fetch(
      'https://c2je1jc4ub.execute-api.eu-central-1.amazonaws.com/beta/stackbot/add-webhook/947b64f5-6507-443d-bcb2-708f51aa51d1/tommyyau/tag-test-v3',
      {
        method: 'POST',
        ...
        <ul className={styles.mid_container}>
          <li className={styles.list}>
            <figure>
              ...
              <figcaption>
                <a href="https://github.com/tommyyau/tag-test-v3/actions?query=workflow%3A%22Studio+%7C+Build+and+Deploy%22">View Studio Deployment</a>
              </figcaption>
            </figure>
            <button
          ...
          <li className={styles.list}>
            <figure>
              ...
              <figcaption>
                <a href="https://github.com/tommyyau/tag-test-v3/actions?query=workflow%3A%22Web+%7C+Build+and+Deploy%22">View Web Deployment</a>
              </figcaption>
            </figure>
            <div>
              <button
